    ...
    <div class="card">
        <div class="card">
            ...
            <div class="card-datatable p-5">
                <form action="{{ route('recruitment-update', ['id' => $jobRequest->id]) }}" method="POST"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="job_title" id="job_title" class="form-control"
                            value="{{ $jobRequest->job_title }}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="" class="form-label">Department</label>
                        <select id="department" name="department" class="form-select" required>
                            <option value="{{ $jobRequest->department }}">{{ $jobRequest->department }}</option>
